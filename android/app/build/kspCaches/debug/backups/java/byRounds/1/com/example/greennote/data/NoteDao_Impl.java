  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`title`,`content`,`createdAt`,`color`) VALUES (?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notes` SET `id` = ?,`title` = ?,`content` = ?,`createdAt` = ?,`color` = ? WHERE `id` = ?";
      }
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpColor);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Note call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpColor;
            _tmpColor = _cursor.getLong(_cursorIndexOfColor);
            _result = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpColor);
          } else {
            _result = null;
          }
          return _result;
